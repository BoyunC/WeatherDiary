package com.ontheway.weatherdiary.controller;

import com.ontheway.weatherdiary.domain.Diary;
import com.ontheway.weatherdiary.service.DiaryService;
...
public class DiaryController {
	...
	List<Diary> readDiaries(@RequestParam @DateTimeFormat(iso = ISO.DATE) @ApiParam(value = "조회할 기간의 첫번째 날입니다.", example = "2022-05-05") LocalDate startDate,
							@RequestParam @DateTimeFormat(iso = ISO.DATE) @ApiParam(value = "조회할 기간의 마지막 날입니다.", example = "2022-05-05") LocalDate endDate){
